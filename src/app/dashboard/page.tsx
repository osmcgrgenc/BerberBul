    ...
    <div className="container mx-auto p-4 flex flex-col md:flex-row gap-8">
      ...
      <aside className="w-full md:w-64 bg-card p-6 rounded-2xl shadow-soft">
        ...
        <nav>
          <ul>
            <li className="mb-4">
              <Link href="/dashboard" className="flex items-center gap-3 text-foreground hover:text-primary font-medium">
                <Calendar size={20} /> Bookings
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/dashboard/favorites" className="flex items-center gap-3 text-foreground hover:text-primary font-medium">
                <Heart size={20} /> Favorites
              </Link>
            </li>
            <li>
              <Link href="/dashboard/profile" className="flex items-center gap-3 text-foreground hover:text-primary font-medium">
      ...
      <main className="flex-1 space-y-8">
        ...
        {/* Profil Yönetimi (Placeholder) */}
        <section className="bg-card p-6 rounded-2xl shadow-soft">
          <h2 className="text-2xl font-bold mb-4">Profile Management</h2>
          <p className="text-muted-foreground">
            Your profile details and settings will appear here.
          </p>
          <Link href="/dashboard/profile" className="mt-4 inline-block bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-2xl shadow-soft transition duration-300">
            Edit Profile
          </Link>
        </section>
      </main>
